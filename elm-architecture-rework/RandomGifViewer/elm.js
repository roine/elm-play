...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $RandomGifViewer = Elm.RandomGifViewer.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({view: $RandomGifViewer.view,update: $RandomGifViewer.update,init: $RandomGifViewer.init,inputs: $RandomGifViewer.inputs});
   var main = app.html;
